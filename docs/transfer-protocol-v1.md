...
The protocol transfers exactly one original source file per session. It does not transfer derived native adaptations, expose the Shelf library API, or expose a filesystem path.

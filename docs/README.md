...
| [性能改进记录（2026-09-15）](performance-improvements-20260915.md) | 展示、编排、会话存储优化的交付与验证边界 |
| [会话存储与事务](conversation-storage.md) | Room 格式、统一 Session、流式提交、旧数据导入与恢复的实际实现 |
...
| [样本依赖核查](reference/sample-dependency-audit.md) | 原卡作者程序的源码引用、运行时证据与阻塞缺口三档清单；不是兼容性结论 |

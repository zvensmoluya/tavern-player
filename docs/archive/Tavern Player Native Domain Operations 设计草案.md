...
> 状态：产品与架构草案，尚未形成实现契约。
>
> 本文补充 [`Tavern Player Native Adaptation 设计原则0903.md`](Tavern%20Player%20Native%20Adaptation%20%E8%AE%BE%E8%AE%A1%E5%8E%9F%E5%88%990903.md) 中尚未展开的行为迁移边界。文中的概念名称不构成对现有 `AdaptationArtifact v1` 的兼容承诺。

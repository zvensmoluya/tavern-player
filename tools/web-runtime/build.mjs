...
for (const file of ['index.html', 'chat.css', 'parent.html']) await copyFile(`src/${file}`, `${output}/${file}`);
...
const names = ['shell.js', 'parent.js', 'programs.js', 'index.html', 'chat.css', 'parent.html', 'jquery.js', 'lodash.js', 'vue.js', 'libraries.js'];

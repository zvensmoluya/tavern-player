...
class AdaptationValidator {
    fun validate(
        ...
        artifact.state.forEachIndexed { index, definition ->
            ...
            val validType = when (definition.type) {
                ...
                AdaptationStateType.NUMBER -> primitive?.doubleOrNull != null
                AdaptationStateType.BOOLEAN -> primitive?.booleanOrNull != null
            }
    ...
    companion object {
        val SUPPORTED_CAPABILITIES: Set<String> = setOf("ui.native", "chat.setDraft", "state.write")
